...
if (!function_exists('coll_other_css')) {
    function coll_other_css()
    {
        ...
        if (!empty($color)) {
            $output .= ".sf-menu a, .sf-menu a:visited, .sf-menu ul a  {\n\t color: $color; \n}\n";
        }
        if (!empty($colorh)) {
