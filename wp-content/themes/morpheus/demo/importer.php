				...
				<form id="coll-demos-form" method="POST" action="?page=coll_install_demo" class="form-horizontal">
					...
					<ul class="choices-container">
						<li class="choice">
							...
							<a target="_blank"
							   href="http://morpheus.smallfacemedia.com/"
						...
						<li class="choice">
							...
							<a target="_blank"
							   href="http://morpheus.smallfacemedia.com/demo1/"
							   class="preview button button-primary"
								><?php _e( 'Preview', 'framework' ); ?></a>
						</li>
						<li class="choice">
							...
							<a target="_blank"
							   href="http://morpheus.smallfacemedia.com/demo2/"
							   class="preview button button-primary"
								><?php _e( 'Preview', 'framework' ); ?></a>
						</li>
						<li class="choice">
							...
							<a target="_blank"
							   href="http://morpheus.smallfacemedia.com/demo3/"
							   class="preview button button-primary"
								><?php _e( 'Preview', 'framework' ); ?></a>
						</li>
						<li class="choice">
							...
							<a target="_blank"
							   href="http://morpheus.smallfacemedia.com/demo4/"
							   class="preview button button-primary"
								><?php _e( 'Preview', 'framework' ); ?></a>
						</li>
					</ul>
...
function coll_importer() {
	...
	if ( current_user_can( 'manage_options' ) && isset( $_POST['coll_install_demo_content'] ) && ! empty( $_POST['coll_demo_file'] ) ) {
		...
		if ( class_exists( 'WP_Importer' ) && class_exists( 'WP_Import' ) ) { // check for main import class and wp import class
			...
			$zip =  get_template_directory() . '/demo/data/' . $demos[ $demo_file ]['name'] . '/ls.zip';
			if ( coll_is_plugin_active( 'LayerSlider/layerslider.php' ) && file_exists($zip) ) {
				include LS_ROOT_PATH . '/classes/class.ls.importutil.php';
				$import = new LS_ImportUtil( $zip );
			}
